...
#line 31 "..\\src\\battery.c"
#line 32 "..\\src\\battery.c"
...
#line 36 "..\\src\\battery.c"
#line 37 "..\\src\\battery.c"
...
void ADC_IRQHandler(void)
{
    if (((NRF_ADC_Type *) 0x40007000UL)->EVENTS_END != 0)
    {
        ...
        {
            do { app_error_handler((err_code), 83, (uint8_t*) "..\\src\\battery.c"); } while (0);
        }
    }
}
...
void battery_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 105, (uint8_t*) "..\\src\\battery.c"); } while (0); } } while (0);

    err_code = sd_nvic_SetPriority(ADC_IRQn, NRF_APP_PRIORITY_LOW);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 108, (uint8_t*) "..\\src\\battery.c"); } while (0); } } while (0);

    err_code = sd_nvic_EnableIRQ(ADC_IRQn);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 111, (uint8_t*) "..\\src\\battery.c"); } while (0); } } while (0);
