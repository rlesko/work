...
accel_char_add(ble_sam_t * p_sam, const ble_sam_init_t * p_sam_init)
{
	  ...
	  chm.p_char_user_desc = 0;
	  chm.p_char_pf = 0;
	  chm.p_user_desc_md = 0;
	  chm.p_cccd_md = &ccm;
  	chm.p_sccd_md = 0;
...
uint32_t ble_sam_init(ble_sam_t * p_sam, const ble_sam_init_t * p_sam_init)
{
	  ...
	  ble_uuid128_t base_uuid = { 0x86, 0xEE, 0x3E, 0xBB, 0x08, 0xAF, 0xD4, 0xF1, 0xAD, 0xD8, 0x9B, 0x82, 0x00, 0x00, 0x1E, 0xF2};
	  ...
	  ec = sd_ble_gatts_service_add(0x01, &id, &p_sam->srvc_handle);
	 	if (ec != ((0x0) + 0))
		  return ec;
