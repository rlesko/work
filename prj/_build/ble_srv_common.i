                                  ...
                                  const ble_srv_report_ref_t * p_report_ref)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (len == 2); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 32, (uint8_t*) "..\\lib\\nrf51822\\Source\\ble\\ble_services\\ble_srv_common.c"); } while (0); } } while (0);
    return len;
}
