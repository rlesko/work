...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (event_size == 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 153, (uint8_t*) "..\\lib\\nrf51822\\Include\\sd_common\\softdevice_handler.h"); } while (0); } } while (0);
...
static __inline void app_timer_evt_get(void * p_event_data, uint16_t event_size)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (event_size == sizeof(app_timer_event_t)); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 282, (uint8_t*) "..\\lib\\nrf51822\\Include\\app_common\\app_timer.h"); } while (0); } } while (0);
...
static __inline void app_button_evt_get(void * p_event_data, uint16_t event_size)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (event_size == sizeof(app_button_event_t)); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 168, (uint8_t*) "..\\lib\\nrf51822\\Include\\app_common\\app_button.h"); } while (0); } } while (0);
...
#line 1 "..\\src\\pstorage_platform.h"
...
#line 9 "..\\src\\pstorage_platform.h"
...
#line 1 "..\\src\\ble_sam.h"




#line 6 "..\\src\\ble_sam.h"
#line 7 "..\\src\\ble_sam.h"
#line 8 "..\\src\\ble_sam.h"
...
{
    do { app_error_handler((nrf_error), 181, (uint8_t*) "..\\src\\main.c"); } while (0);
} 
...
static void accel_meas_timeout_handler(void * p_context)
{
    ...
    ((void)(p_context));
	  ...
	  zes_lis3dsh_data(&zes_Lis3dsh, 0);
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((4)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (4), (4) + 1, APP_TIMER_BUF, (1) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 234, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0); } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 241, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0); 
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_device_name_set(&sec_mode,
                                          ...
                                          strlen("Zendo_Sensor"));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 266, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);

     
    err_code = sd_ble_gap_appearance_set(960);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 270, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0); 
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 280, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
}
...
static void advertising_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 314, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
}
...
static void services_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 343, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
	
	  
    do {(&sam_init . accel_char_attr_md . cccd_write_perm)->sm = 1; (&sam_init . accel_char_attr_md . cccd_write_perm)->lv = 1;} while(0);
		do {(&sam_init . accel_char_attr_md . read_perm)->sm = 1; (&sam_init . accel_char_attr_md . read_perm)->lv = 1;} while(0);
    
    do {(&sam_init . accel_char_attr_md . write_perm)->sm = 0; (&sam_init . accel_char_attr_md . write_perm)->lv = 0;} while(0);
		
	  sam_init.evt_handler          = 0;
    sam_init.support_notification = 1;
    sam_init.p_report_ref         = 0;
		
		err_code = ble_sam_init(&sam ,&sam_init);
		do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 356, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
}
...
static void on_conn_params_evt(ble_conn_params_evt_t * p_evt)
{
    ...
    if(p_evt->evt_type == BLE_CONN_PARAMS_EVT_FAILED)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 390, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
    }
}
...
{
    do { app_error_handler((nrf_error), 401, (uint8_t*) "..\\src\\main.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 424, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
}
...
static void timers_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 436, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
	
	  err_code = app_timer_start(m_accel_timer_id, ((uint32_t)((((2000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 439, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
}
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 460, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
    nrf_gpio_pin_set(8);
}
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            err_code = sd_ble_gap_sec_params_reply(m_conn_handle,
                                                   0x00,
                                                   &m_sec_params);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 511, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
            break;

        case BLE_GATTS_EVT_SYS_ATTR_MISSING:
            err_code = sd_ble_gatts_sys_attr_set(m_conn_handle, 0, 0);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 516, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
            break;
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            if (p_enc_info->div == p_ble_evt->evt.gap_evt.params.sec_info_request.div)
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 528, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
            }
            else
            {
                
                err_code = sd_ble_gap_sec_info_reply(m_conn_handle, 0, 0);
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 534, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
            }
            break;
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 609, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);

    
    err_code = softdevice_ble_evt_handler_set(ble_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 613, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
    
    
    err_code = softdevice_sys_evt_handler_set(sys_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 617, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
}
...
{
    do { static uint32_t APP_SCHED_BUF[((((((((sizeof(app_timer_event_t))) + 8) * (((10)) + 1))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_sched_init((sizeof(app_timer_event_t)), (10), APP_SCHED_BUF); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 625, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0); } while (0);
}
...
{
    do { static uint32_t app_gpiote_buf[((((((1) * 20)) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_gpiote_init((1), app_gpiote_buf); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 658, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void buttons_init(void)
{
    ...
    do { uint32_t ERR_CODE = app_button_init((buttons), (sizeof(buttons) / sizeof(buttons[0])), (((uint32_t)((((50) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)))), (1) ? app_button_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 675, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0); } while (0);
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 688, (uint8_t*) "..\\src\\main.c"); } while (0); } } while (0);
}
...
int main(void)
{
	  ...
	  zes_sys_pwld(1);
		...
		zes_spi_setup(&zes_Spi0, ((NRF_SPI_Type *) 0x40003000UL), 30, 28, 29, 25, zes_spi_8Mbps);
