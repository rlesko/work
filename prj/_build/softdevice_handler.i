...
void intern_softdevice_events_execute(void)
{
    ...
    for (;;)
    {
        ...
        if (!no_more_soc_evts)
        {
            ...
            {
                do { app_error_handler((err_code), 105, (uint8_t*) "..\\lib\\nrf51822\\Source\\sd_common\\softdevice_handler.c"); } while (0);
            }
            else
            {
        ...
        if (!no_more_ble_evts)
        {
            ...
            {
                do { app_error_handler((err_code), 128, (uint8_t*) "..\\lib\\nrf51822\\Source\\sd_common\\softdevice_handler.c"); } while (0);
            }
            else
            {
...
void SWI2_IRQHandler(void)
{
    if (m_evt_schedule_func != 0)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 306, (uint8_t*) "..\\lib\\nrf51822\\Source\\sd_common\\softdevice_handler.c"); } while (0); } } while (0);
    }
    else
    {
        intern_softdevice_events_execute();
