...
#line 8 "..\\src\\zes_spi.c"
#line 9 "..\\src\\zes_spi.c"
#line 10 "..\\src\\zes_spi.c"
...
zes_spi_init(zes_spi_t *s)
{
	...
	switch (s->speed)
	{
		case zes_spi_125kbps: s->device->FREQUENCY = (0x02000000UL); break;
		case zes_spi_250kbps: s->device->FREQUENCY = (0x04000000UL); break;
		case zes_spi_500kbps: s->device->FREQUENCY = (0x08000000UL); break;
		case zes_spi_1Mbps: s->device->FREQUENCY = (0x10000000UL); break;
		case zes_spi_2Mbps: s->device->FREQUENCY = (0x20000000UL); break;
		case zes_spi_4Mbps: s->device->FREQUENCY = (0x40000000UL); break;
		case zes_spi_8Mbps: s->device->FREQUENCY = (0x80000000UL); break;
	}

	s->device->ENABLE = (0x01UL) << (0UL);
...
{
	if ((((NRF_GPIO_Type *) 0x50000000UL)->OUT >> s->ssel) & 1)
	{
