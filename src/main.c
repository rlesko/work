...
#define CONNECTED_LED_PIN_NO            LED_3                                       /**< Is on when device has connected. */
#define ASSERT_LED_PIN_NO               LED_7                                       /**< Is on when application has asserted. */

#define DEVICE_NAME                     "Zendo_Sensor"                           /**< Name of device. Will be included in the advertising data. */
